    ...
    <div className="flex flex-wrap justify-center gap-4 pb-10">
      ...
      <div className="w-full sm:w-1/2 p-4 border rounded-lg ">
        <video muted loop className="w-full h-auto" autoPlay>
          <source
            src="https://pub-0cd6f9d4131f4f79ac40219248ae64db.r2.dev/easy-template-5.mp4"
            type="video/mp4"
          />
        </video>
      </div>
      <div className="sm:w-1/2 p-4">
        <div className="flex justify-between">
          <Button
            ...
            onClick={() => {
              ...
              link.href =
                "https://github.com/DarkInventor/easy-tailwind/archive/refs/heads/main.zip"
          ...
          <Button
            ...
            type="submit"
            onClick={() =>
              window.open("https://easy-template-5.vercel.app/", "_blank")
            }
          >
            Live Preview
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            Landing Page? This template is designed with the latest tech stack,
