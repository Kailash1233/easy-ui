    ...
    <section id="hero">
      <div className="flex flex-col items-start gap-6 mt-20 lg:mt-10 md:mt-10 px-7 text-center md:items-center pb-0 lg:pb-14 md:pb-14 sm:pb-0">
        ...
        <div className="relative flex flex-col gap-4 md:items-center lg:flex-row">
          <h1 className="relative mx-0 max-w-[36.8rem] text-balance bg-gradient-to-br from-black from-50% to-neutral-200/60 bg-clip-text pt-5 text-left text-5xl font-semibold tracking-tighter text-transparent sm:text-7xl md:mx-auto md:px-4 md:py-2 md:text-center md:text-7xl lg:text-7xl dark:text-white">
